          ...
          <div className="text-center">
            ...
            <div className="max-w-3xl mx-auto mb-12">
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                ...
                From medical emergencies to life's journey, we're here – not just for benefits,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-primary-50 p-6 rounded-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Acknowledged by Central Luzon Conference (CLC) since 2015
              </p>
            </div>
            ...
            <div className="bg-primary-50 p-6 rounded-lg hover:shadow-xl transition-shadow">
              ...
              <ul className="text-gray-700 space-y-1 text-sm">
                <li>• Benefits for medical needs</li>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">
                      ...
                      communities and the broader public. We provided benefits and spiritual inspiration to members
            ...
            {/* More Than Financial */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">More Than Benefits</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                HIM is not simply a mutual aid or damayan program. We are a community united by faith, compassion,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-primary-600 text-white p-8 rounded-lg">
                ...
                <p className="leading-relaxed">
                  ...
                  benefits, spiritual care and prayer, personal presence and sympathy,
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            ...
            <p className="mt-2">Recognized by Central Luzon Conference (CLC) since 2015</p>
          </div>
        </div>
      </footer>
    </div>
